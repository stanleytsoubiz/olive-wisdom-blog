...
qc_gate:
  ...
  H6: pass
faq:
  - q: "橄欖油 CoA 是什麼？一般消費者需要看嗎？"
    a: "CoA（Certificate of Analysis，品質分析報告）是針對特定批次橄欖油所做的理化檢測報告，必須由通過 ISO/IEC 17025 認證的獨立第三方實驗室出具，品牌不得自行發布。報告記載該批次油的實際化學參數，是目前最難偽造的品質佐證文件。對一般消費者而言，CoA 是識破行銷話術的關鍵工具：它把「頂級品質」的口號，轉換成可對照 IOC 國際標準的具體數字。尤其是高單價特級初榨橄欖油，索取並核對 CoA 是避免買到劣質品的最直接方式。"
  - q: "橄欖油 CoA 上哪幾個數值最重要？標準是什麼？"
    a: "依 IOC（國際橄欖理事會）2022 年貿易標準，特級初榨橄欖油（EVOO）的四大核心指標門檻如下：酸值（FFA）必須 ≤0.8%，數字越低代表採收與壓榨品質越嚴謹；過氧化值（Peroxide Value）必須 ≤20 meq/kg，反映油脂氧化程度；K232 ≤2.50、K268 ≤0.22，兩項紫外線吸光度指標用以偵測更深層的氧化降解。此外，多酚含量（Total Polyphenols）雖非 IOC 強制門檻，但頂級 EVOO 通常 ≥200 mg/kg，部分高多酚品項可達 400–600 mg/kg，是衡量油品「活性」的重要參考指標。"
  - q: "橄欖油多酚含量 CoA 上怎麼看？數字高就代表比較健康嗎？"
    a: "CoA 上的多酚數據通常以「Total Polyphenols（TPC）」呈現，單位為 mg/kg。歐盟 2012 年健康聲稱法規（EC No 432/2012）指出，每日攝取含至少 5mg hydroxytyrosol 及其衍生物的橄欖油，有助於保護血脂不受氧化壓力損傷，對應油品的多酚含量標準約為 ≥250 mg/kg。研究顯示，高多酚橄欖油中的 oleocanthal 成分具有類似布洛芬的抗炎特性（Beauchamp et al., 2005）。但需注意：多酚含量高不等於可做出醫療效果聲稱；多酚在開瓶後會因光照與氧化快速流失，因此購買時的 CoA 數字僅代表出廠時的狀態，開瓶後應盡快使用。"
  - q: "在哪裡可以取得一瓶橄欖油的 CoA 報告？品牌都會提供嗎？"
    a: "負責任的特級初榨橄欖油品牌通常有以下幾種提供方式：一、官方網站公開下載，依批次號碼（Lot Number）可查對應報告；二、購買頁面或產品頁面附有 PDF 連結；三、透過客服信箱、LINE 官方帳號等管道，提供批次號碼後索取。若品牌拒絕提供、無法提供、或提供的報告出具機構無法在 ISO/IEC 17025 認可實驗室名單中查核，均為警示訊號。在台灣市場，消費者可直接向品牌客服要求提供最新批次 CoA；若為電商平台商品，可在問答區公開詢問，讓品牌公開回應，這同時也有助於建立市場透明度。"
draft: false
---
...
多酚（Polyphenol，讓橄欖油入喉後帶有辛辣感的植物抗氧化物質）是特級初榨橄欖油獨有的標誌性成分。含量越高，油的「活性」越強，那股辛辣刺激感也越明顯。關於這些活性物質對人體的具體作用，可參考[橄欖油多酚的七大科學效益](/posts/olive-oil-health-benefits-polyphenol-science-complete)的系統性整理。
