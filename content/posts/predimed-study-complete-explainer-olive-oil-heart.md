...
faq:
  - q: "PREDIMED 研究的主要發現是什麼？"
    a: "PREDIMED 研究發現，與低脂飲食組相比，補充特級初榨橄欖油（EVOO）的地中海飲食組心血管事件（心臟病發作、中風、心血管疾病死亡）發生率約低 30%，補充堅果的地中海飲食組則約低 28%。這是迄今最大規模的地中海飲食隨機對照試驗之一。"
  ...
  - q: "PREDIMED 研究的結論可以應用於亞洲人嗎？"
    a: "PREDIMED 是在西班牙人群中進行的研究，受試者的遺傳背景、飲食基礎和生活型態與亞洲人有所不同。但多項亞洲的觀察性研究也觀察到橄欖油攝入量與心血管指標較佳表現有相關。PREDIMED 的結論提供了強力的機理支持，但在直接應用於亞洲人群時應參照更多本地研究。我們的建議是：現有證據已足夠支持把好的 EVOO 納入台灣的日常飲食，不需要等到有台灣本地的大型 RCT 才行動。"
---
